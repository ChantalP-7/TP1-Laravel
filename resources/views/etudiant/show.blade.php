 ...
 <div class="row justify-content-center">
    ...
    <div class="col-md-8"> 
        ...
        <div class="card mb-4 border-0">
            <div class="card-header text-white background-soft rounded-0 pt-2 pb-0">
            ...
            <div class="card-footer bg-white border-0 rounded mt-3 mb-5">
                <div class="d-flex justify-content-between mb-5">
                   <a href="{{route('etudiant.edit', $etudiant->id)}}" class="btn btn-sm background-soft align-center fs-5">Éditer 
                    ...
                    <button type="button" class="btn btn-sm tomato align-center fs-5" data-bs-toggle="modal" data-bs-target="#deleteModal">
                        Supprimer <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" class="bi bi-trash3" viewBox="0 0 16 16">
                            <path d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5M11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47M8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5"/>
                            </svg>
                    </button>                    
                </div>
                <hr class="mt-2 mb-4" />
                <a href="{{ route('etudiant.index') }}" class="col-md-3 btn fw-bold text-decoration-underline text-primary text-bold">
                ← Retour à la liste
            </a>  
            </div> 
