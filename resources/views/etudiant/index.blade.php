 ...
 <div class="row">
    ...
    <div class="col-md-4 border-0">
        <div class="card mb-4 border-0">
            <div class="card-header background-soft text-white border-0 rounded-0 pt-2 pb-0">
                <h5 class="card-title  fs-5">{{$etudiant->nom}}</h5>
            </div>
            <div class="card-body">               
            ...
            <div class="card-footer border-0 bg-white">
                <div class="d-flex justify-content-start gap-5 ">
                    <a href="{{ route('etudiant.edit', $etudiant->id)}}" class="btn btn-sm btn-special "><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="white" class="bi bi-pencil-square" viewBox="0 0 16 16">
